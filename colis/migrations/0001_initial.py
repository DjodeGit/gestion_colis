    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to.', related_name='coustomuser_set', to='auth.group', verbose_name='groups')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this user.', related_name='coustomuser_permissions_set', to='auth.permission', verbose_name='user permissions')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='colis.agent')),
        ...
        migrations.AddField(
            model_name='colis',
            name='expediteur',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='colis.expediteur'),
        ),
        migrations.CreateModel(
            name='Livraison',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='colis.agent')),
                ('colis', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='colis.colis')),
                ('transporteur', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='colis.transporteur')),
            ],
        ),
        migrations.AddField(
            model_name='colis',
            name='transporteur',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='colis.transporteur'),
        ),
    ]
