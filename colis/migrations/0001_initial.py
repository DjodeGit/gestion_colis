    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('agent', 'Agent'), ('expediteur', 'Expéditeur'), ('destinataire', 'Destinataire')], default='agent', max_length=50)),
                ('date_creation', models.DateTimeField(default=django.utils.timezone.now)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auteur', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='articles', to='colis.utilisateur')),
            ],
            options={
